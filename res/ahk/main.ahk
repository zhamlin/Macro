Class Main Extends CGUI
{
    ...
    __New()
    {
        this.AddControl("Button", "btnHelp", "x730 y390 w75 h23 ", "&Help")
        this.AddControl("Button", "btnOK", "x570 y390 w75 h23 ", "&OK")
    ...
    {
        if (this.tab = "Script")
            MsgBox, OnEvent is called everytime a key assigned to "Script" is pressed.
        else
            MsgBox, Click Add to add a key`nRight click a key from listview for menu.
    }
