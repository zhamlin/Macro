...
HotkeyGUI(p_Owner="",p_Hotkey="",p_Limit="",p_OptionalAttrib=False,p_Title="")
    ...
    gui %s_GUI%:Add
       ,CheckBox
       ,xp+110 Disabled Section vHG_UpOption gHotkeyGUI_UpdateHotkey
       ,Up   
    ...
    if HG_Key
        GUIControl %s_GUI%:Enable,Button19
     else
        GUIControl %s_GUI%:Disable,Button19
